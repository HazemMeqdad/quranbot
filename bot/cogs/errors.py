...
class Errors(commands.Cog):
    ...
    async def on_command_error(self, ctx, error):
        ...
        # missing permissions
            ...
            await ctx.reply(
                embed=discord.Embed(
                    description=_["missing_perms"] % (", ".join(error.missing_permissions), self.emoji.errors),
                    color=color
                )
            )
        # command not found
        ...
        # bot missing permissions
            ...
            await ctx.reply(
                embed=discord.Embed(
                    description=_["bot_missing_permissions"] % (", ".join(error.missing_permissions), self.emoji.errors),
                    color=color
                )
            )
        # message not found
